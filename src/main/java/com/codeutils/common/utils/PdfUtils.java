...
public class PdfUtils {
     ...
     * @throws DocumentException 文档异常
     */
    public static void addHyperlink(Document document, String text, String url) throws DocumentException {
        Anchor anchor = new Anchor(text);
        anchor.setReference(url);
        anchor.setFontColor(BaseColor.BLUE);
        anchor.setUnderline(0.1f, 0f);
        document.add(anchor);
    }
